...
*/
  ...
  $content .= '<p>Use Read It Later<br />Email address or username: <input type="text" name="rl_user" value="'. setting_fetch('rl_user', '').'" size="20" class="linput" /><br />';
  $content .= 'Password, if you have one.: <input type="password" name="rl_pass" value="'. setting_fetch('rl_pass', '').'" size="20" class="linput" /></p><hr />';
...
//  $content .= '<p><label><input type="checkbox" name="showthumbs" value="yes" '. (setting_fetch('showthumbs', 'yes') == 'yes' ? ' checked="checked" ' : '') .' /> Preview Photos In Timelines</label></p><hr />';
  ...
  $content .= '<p><label>RT Syntax:<br /><input type="text" id="rtsyntax" name="rtsyntax" value="'.setting_fetch('rtsyntax', 'RT [User]: [Content]').'" maxlength="140" size="20" class="linput" /></label><br /><span class="texts">Default RT Syntax: RT [User]: [Content]</span></p><hr />';
  ...
  $content .= '<p><label><input type="checkbox" name="filtero" value="yes" '. (setting_fetch('filtero', 'no') == 'yes' ? ' checked="checked" ' : '') .' /> Keyword Filter:</label> <input type="text" id="filterc" name="filterc" value="'.setting_fetch('filterc').'" maxlength="140" size="20" class="linput" /><br /><span class="texts">Note: Separate keywords with space</span></p><hr />';
