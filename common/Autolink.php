...
class Twitter_Autolink extends Twitter_Regex {
  ...
  /**
   * Whether to include the value 'tag' in the 'rel' attribute.
   *
   * @var  bool
   */
  protected $tag = true;
  ...
  /**
   * Whether to include the value 'noreferrer' in the 'rel' attribute.
   *
   * @var  bool
   */
  protected $noreferrer = true;
   ...
   * Whether to include the value 'tag' in the 'rel' attribute.
   *
   * @return  bool  Whether to add 'tag' to the 'rel' attribute.
   */
   ...
   * Whether to include the value 'noreferrer' in the 'rel' attribute.
   *
   * @return  bool  Whether to add 'noreferrer' to the 'rel' attribute.
   */
  public function getNoReferrer() {
   ...
   * @return  Twitter_Autolink  Fluid method chaining.
   */
  public function setNoReferrer($v) {
    $this->noreferrer = $v;
    return $this;
  }
  ...
  protected function wrap($url, $class, $element) {
    ...
    if ($this->tag) $rel[] = 'tag';
    if ($this->noreferrer) $rel[] = 'noreferrer';
