...
<p><label>Username <input name="username" size="15" class="ninput" /></label>
<br /><label>Password <input name="password" type="password" size="15" class="ninput" /></label>
<br /><label><input type="checkbox" checked="checked" value="yes" name="stay-logged-in" /> Stay logged in?</label>
<br /><button type="submit">Sign In</button></p>
</form>
